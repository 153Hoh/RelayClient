...
public interface IUsbManager extends android.os.IInterface {
     ...
     */
    public android.os.ParcelFileDescriptor openDevice(String deviceName)
    ...
    public void setDevicePackage(UsbDevice device,
                                 String packageName, int userId) throws android.os.RemoteException;

    /*
     * Sets the default package for a USB accessory (or clears it if the package
     * name is null)
     */
    public void setAccessoryPackage(UsbAccessory accessory,
     ...
     */
    public void requestAccessoryPermission(UsbAccessory accessory,
                                           String packageName, android.app.PendingIntent pi)
            throws android.os.RemoteException;
     ...
     * for the package
     */
    public boolean hasDefaults(String packageName) throws android.os.RemoteException;

    /* Clears default preferences and permissions for the package */
    public void clearDefaults(String packageName) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements
         ...
         * @param obj
         */
        public static IUsbManager asInterface(final android.os.IBinder obj) {
            throw new RuntimeException("Stub!");
        }
